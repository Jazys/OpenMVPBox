...
if (array_key_exists("sae", $_POST) &&
    ...
    try {
        ...
        if (version_compare(phpversion(), "7.0", "<") ||
            ...
            throw new Exception("PHP 7.0, 7.1, 7.2 or 7.3 is required, see <a href=\"https://doc.siberiancms.com/knowledge-base/siberian-server-requirements/\">siberian-server-requirements</a> for more informations \n");
        }
...
function fileIsValid($md5 = null)
{
    ...
    return is_file($archive_base_path) && @md5_file($archive_base_path) === _getMd5();
}
...
{
    $base_file_path = BASE_PATH . "/ping.txt";
    return is_file($base_file_path) &&
        @file_get_contents($base_file_path) == "1";
}
...
function setPermissions()
{
    ...
    $full_permissions_directories = ['images', 'languages', 'var'];
    foreach ($collection as $item) {
        ...
        if ($item->isDir()) {
            if (in_array($part, $full_permissions_directories, true)) {
...
<div id="downloader"
        ...
        <form id="installForm" method="post" action="/">
            ...
            <?php if(!checkDomain($_SERVER["HTTP_HOST"])): ?>
                <div class="note_information" style="color:#c20000;">
                    <strong>It looks like you are installing on a local domain or IP, please install from your domain name.</strong>
                </div>
            <?php endif; ?>
            <div style="margin-top: 20px;">
                <a style="padding: 3px 6px; font-size: 13px;"
                   href="/index.php?phpinfo=1"
                   target="_blank">Check phpinfo()</a>
                &nbsp;&nbsp;&nbsp;
                <a style="padding: 3px 6px; font-size: 13px; background-color: #ff9019 !important; color: white !important;"
    ...
    if (!empty($error_message)) {
        echo "<h4 id=\"alert_message\"><strong>Please fix the following errors:</strong><br />" . $error_message . "</h4>";
    }
    ?>
